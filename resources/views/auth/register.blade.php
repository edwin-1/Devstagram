        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            ...
            <form action="{{route('register')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="username" name="username" type="text" placeholder="Tu Usuario de Registro" class="border p-3 w-full rounded-lg
                ...
                <div class="mb-5">
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Repetir Tu Password" class="border p-3 w-full rounded-lg">
                </div>

            

                <input type="submit" value="Crear Cuenta" 
                class="bg-sky-600 hover:bg-sky-700 transition-colors cursor-pointer uppercase font-bold w-full p-5 text-white rounded-lg">
            </form>
